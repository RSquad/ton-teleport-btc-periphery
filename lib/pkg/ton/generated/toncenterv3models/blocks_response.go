...
func (m *BlocksResponse) validateBlocks(formats strfmt.Registry) error {
...
func (m *BlocksResponse) contextValidateBlocks(ctx context.Context, formats strfmt.Registry) error {
