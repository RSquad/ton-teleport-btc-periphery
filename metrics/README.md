...
- `COMMON_TON_CONTRACT_COORDINATOR` - Address of the Coordinator contract on TON (required)
- `COMMON_TON_CONTRACT_TELEPORT_ADDR` - Address of the Teleport contract on TON (required)
- `COMMON_TON_CONTRACT_BITCLIENT_ADDR` - Address of the BitcoinClient contract on TON (required)
- `COMMON_TON_CONTRACT_MINTER_ADDR` - Address of the Minter contract on TON (required)
- `COMMON_TON_RELAYER_WALLET_ADDR` - Address of the Relayer wallet on TON (required)
