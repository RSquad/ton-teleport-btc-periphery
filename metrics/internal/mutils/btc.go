...
func BtcGetBestBlockHeight(bitcoinClient bitcoin.ClientInterface) (int, error) {
...
func BtcGetCPFPChainSize(bitcoinClient bitcoin.ClientInterface, txHash *chainhash.Hash) (int, error) {
	chainSize := 0
