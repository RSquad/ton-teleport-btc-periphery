...
func TestAlertPegoutSigners(t *testing.T) {
	...
	runbookUrl := mutils.CreateShortLink("link", "http://runbook/PegoutSigners.md")
	...
	tests := []TestDesc{
		...
		},
		{
			...
			Expect: TestResWant{
				...
				Description: Description(fmt.Sprintf("Number of validators allowed to sign pegout is 9 of 10 (90%%). Pegout: %s. Bitcoin TX: %s. Runbook url: %s", tonUrl1, btcUrl1, runbookUrl)),
				Err:         nil,
			},
		},
		{
			...
			Expect: TestResWant{
				...
				Description: Description(fmt.Sprintf("Number of validators allowed to sign pegout is 8 of 10 (80%%). Pegout: %s. Bitcoin TX: %s. Runbook url: %s", tonUrl1, btcUrl1, runbookUrl)),
				Err:         nil,
			},
		},
		{
			...
			Expect: TestResWant{
				...
				Description: Description(fmt.Sprintf("Number of validators allowed to sign pegout is 7 of 10 (70%%). Pegout: %s. Bitcoin TX: %s. Runbook url: %s", tonUrl1, btcUrl1, runbookUrl)),
				Err:         nil,
			},
		},
		{
			...
			Expect: TestResWant{
				Severity:    SEVERITY_CRITICAL,
				Description: Description(fmt.Sprintf("Number of validators allowed to sign pegout is 6 of 10 (60%%). Pegout: %s. Bitcoin TX: %s. Runbook url: %s", tonUrl1, btcUrl1, runbookUrl)),
				Err:         nil,
			},
		},
		{
			...
			Expect: TestResWant{
				Severity:    SEVERITY_CRITICAL,
				Description: Description(fmt.Sprintf("Number of validators allowed to sign pegout is 6 of 10 (60%%). Pegout: %s. Bitcoin TX: %s. Runbook url: %s", tonUrl2, btcUrl2, runbookUrl)),
				Err:         nil,
			},
		},
		{
