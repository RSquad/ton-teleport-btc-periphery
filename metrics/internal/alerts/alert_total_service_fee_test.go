	...
	tests := []TestDesc{
		...
		},
		{
			...
			Expect: TestResWant{
				...
				Description: Description(fmt.Sprintf("Total service fee is less than 3000 satoshi. Runbook url: %s", runbookUrl)),
				Err:         nil,
			},
		},
		{
			...
			Expect: TestResWant{
				...
				Description: Description(fmt.Sprintf("Total service fee is less than 0 satoshi. Runbook url: %s", runbookUrl)),
				Err:         nil,
			},
		},
		{
